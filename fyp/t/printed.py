...
for i in range(num_frames):
    ...
    if len(upscale_bbox) > 0:
        ...
        if rshX>0 and rhipX>0 and lshX>0 and lhipX>0: 
            ...
            s_img = cv2.imread("fyp/t/images/printed/shirt"+shirt_ch+".png", -1)
            h=s_img.shape[0]
            w=s_img.shape[1]
        ...
        if lshX>0 and lelbX>0:
            ...
            s_img = cv2.imread("fyp/t/images/printed/lsh"+shirt_ch+".png", -1)
        ...
        if rshX>0 and relbX>0:
            ...
            s_img = cv2.imread("fyp/t/images/printed/rsh"+shirt_ch+".png", -1)
            height = int(s_img.shape[0]*verticalr*1.5)
            width = int(s_img.shape[1]*horizontalr)
            if height>0 and width>0:
                s_img=cv2.resize(s_img,(width,height))
        ...
        if pant_enabled:
            ...
            if rshX>0 and rhipX>0 and lshX>0 and lhipX>0 and lkneeX>0 and rkneeX>0:
                ...
                s_img = cv2.imread("fyp/t/images/leftthigh.png", -1)
                h=s_img.shape[0]
                w=s_img.shape[1]
            ...
            if rshX>0 and rhipX>0 and lshX>0 and lhipX>0 and lkneeX>0 and rkneeX>0:
                ...
                s_img = cv2.imread("fyp/t/images/rightthigh.png", -1)
                #h=s_img.shape[0]
                #w=s_img.shape[1]
                #width = int(hipwidth*pant_size*1.2/2)
                #height = int(th_height*pant_size)
                height = int(s_img.shape[0]*verticalr)
                width = int(s_img.shape[1]*horizontalr)
                rthh = height
                rthw = width
                verticalr = height/h
            ...
            if lkneeX>0 and lfootX>0:
                s_img = cv2.imread("fyp/t/images/leftknee.png", -1)
            ...
            if rkneeX>0 and rfootX>0 :
                s_img = cv2.imread("fyp/t/images/rightknee.png", -1)
        ...
        if glass_enabled:
            if right_eyeX>0 and left_eyeX>0 and right_earX>0 and left_earX>0:
                s_img = cv2.imread("glass/fyp/t/images/glasses"+glass_ch+".png",-1)
    ...
    cv2.imshow("Illusion Of Wearing",frame)
