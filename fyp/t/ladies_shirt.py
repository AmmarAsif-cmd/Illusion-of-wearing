...
for i in range(num_frames):
    ...
    if len(upscale_bbox) > 0:
        ...
        if rshX>0 and rkneeX>0 and lshX>0 and lkneeX>0: 
            ...
            umidX = (rshX+lshX)/2
            umidY = (rshY+lshY)/2
            lmidX = (rkneeX+lkneeX)/2
            lmidY = (rkneeY+lkneeY)/2
            angle=(math.atan2(umidY-lmidY, umidX-lmidX) * 180 / 3.14)-270
            body_height=Distance(umidX,umidY,lmidX,lmidY)
            s_img = cv2.imread("fyp/t/images/ladies_shirts/shirt"+shirt_ch+".png", -1)
            h=s_img.shape[0]
            w=s_img.shape[1]
        ...
        if lshX>0 and lelbX>0:
            ...
            s_img = cv2.imread("fyp/t/images/ladies_shirts/lsh"+shirt_ch+".png", -1)
        ...
        if rshX>0 and relbX>0:
            ...
            s_img = cv2.imread("fyp/t/images/ladies_shirts/rsh"+shirt_ch+".png", -1)
